...
if [ ! -f ./Win32/Release/renderdoc.dll ] || [ ! -f ./Win32/Release/qredendoc.exe ] || [ ! -f ./Win32/Release/redendoccmd.exe ] ; then
...
if [ ! -f ./x64/Release/renderdoc.dll ] || [ ! -f ./x64/Release/qredendoc.exe ] || [ ! -f ./x64/Release/redendoccmd.exe ] ; then
